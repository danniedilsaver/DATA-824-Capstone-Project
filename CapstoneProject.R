  ...
  sidebarLayout(
    ...
    mainPanel(
      tabsetPanel(
        ...
        tabPanel("Summary Statistics by Variable", verbatimTextOutput("summary")),
...
#  df.num1 = df.num[1:5]
# pairs(df.num1, col = "lightblue")
#})

#df.num2 = df.num[6:10]
#df.num3 = df.num[11:15]
#df.num4 = df.num[16:20]


# pairs(df.num2, col = "blue")
#  pairs(df.num3, col = "pink")
#pairs(df.num4, col = "red")
#})